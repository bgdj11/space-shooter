...
{
	CreateIntroWave(spriteManager, view);
...
std::vector<std::shared_ptr<Enemy>>& EnemyManager:: GetIntroWave()
{
	return introWave;
}
...
{	
	...
	{
		introWave.erase(
			std::remove_if(introWave.begin(), introWave.end(),
...
void EnemyManager::CreateIntroWave(SpriteManager* spriteManager, sf::View& view)
{
	sf::Texture& firstEnemyTexture = spriteManager->GetTexture("../sprites/Enemy1_Ss_png.png");
	sf::Texture& basicEnemyProjectileTexture = spriteManager->GetTexture("../sprites/enemy_laser.png");

	std::shared_ptr<BasicEnemy> enemy1 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.1f, 150.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy1);
	std::shared_ptr<BasicEnemy> enemy2 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.1f, 250.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy2);
	std::shared_ptr<BasicEnemy> enemy3 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.1f, 350.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy3);
	std::shared_ptr<BasicEnemy> enemy4 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.3f, 150.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy4);
	std::shared_ptr<BasicEnemy> enemy5 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.3f, 250.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy5);
	std::shared_ptr<BasicEnemy> enemy6 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.3f, 350.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy6);
	std::shared_ptr<BasicEnemy> enemy7 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.7f, 150.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy7);
	std::shared_ptr<BasicEnemy> enemy8 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.7f, 250.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy8);
	std::shared_ptr<BasicEnemy> enemy9 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.7f, 350.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy9);
	std::shared_ptr<BasicEnemy> enemy10 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.9f, 150.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy10);
	std::shared_ptr<BasicEnemy> enemy11 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.9f, 250.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy11);
	std::shared_ptr<BasicEnemy> enemy12 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(290.0f, 86.0f), sf::Vector2f(view.getSize().x * 0.9f, 350.0f), &basicEnemyProjectileTexture);
	introWave.push_back(enemy12);
}
