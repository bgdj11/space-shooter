...
void EnemyManager::CreateFirstWave(SpriteManager* spriteManager, sf::View& view)
{
	...
	std::shared_ptr<BasicEnemy> enemy1 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.2f, 160.0f));
	firstWave.push_back(enemy1);
	std::shared_ptr<BasicEnemy> enemy2 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.8f, 160.0f));
	firstWave.push_back(enemy2);
	std::shared_ptr<BasicEnemy> enemy3 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.3f, 250.0f));
	firstWave.push_back(enemy3);
	std::shared_ptr<BasicEnemy> enemy4 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.7f, 250.0f));
	firstWave.push_back(enemy4);
	std::shared_ptr<BasicEnemy> enemy5 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.45f, 460.0f));
	firstWave.push_back(enemy5);
	std::shared_ptr<BasicEnemy> enemy6 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.55f, 460.0f));
	firstWave.push_back(enemy6);
	std::shared_ptr<BasicEnemy> enemy7 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.85f, 350.0f));
	firstWave.push_back(enemy7);
	std::shared_ptr<BasicEnemy> enemy8 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.15f, 350.0f));
	firstWave.push_back(enemy8);
	std::shared_ptr<BasicEnemy> enemy9 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x / 2.0f, 290.0f));
	firstWave.push_back(enemy9);
	std::shared_ptr<BasicEnemy> enemy10 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.4f, 290.0f));
	firstWave.push_back(enemy10);
	std::shared_ptr<BasicEnemy> enemy11 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.6f, 290.0f));
	firstWave.push_back(enemy11);
	std::shared_ptr<BasicEnemy> enemy12 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.12f, 220.0f));
	firstWave.push_back(enemy12);
	std::shared_ptr<BasicEnemy> enemy13 = std::make_shared<BasicEnemy>(&firstEnemyTexture, sf::Vector2f(330.0f, 100.0f), sf::Vector2f(view.getSize().x * 0.88f, 220.0f));
